...
return [
    ...
    'header'        => [
        ...
        'profile'           => 'Perfil',
        'wishlist'          => 'Wishlist',
        'all-categories'    => 'Todoas las categorias',
    ...
    'menu-navbar'   => [
        'text-more'     => 'More',
        'text-category' => 'Ver por categorías',
    ],
    ...
    'checkout'      => [
        ...
        'subtotal'  => 'Subtotal',
        'sub-total' => 'Sub Total',
        'proceed'   => 'Proceder a la compra',
    ],

    'customer'      => [
        'compare'           => [
            'text'                  => 'Comparar',
            'compare_similar_items' => 'Comparar',
            'add-tooltip'           => 'Agregar a la lista de comparación',
